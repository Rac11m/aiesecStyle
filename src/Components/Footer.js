...
const Footer = () => {
  return (
    <Container
      fluid
      style={{ padding: "5rem 5rem 2rem 5rem", textAlign: "center" }}
    >
      ...
      <Row className="Footer-row">
        ...
        <Col className="pt-5 align">
          ...
          <div className="social">
            ...
            <p className="copyright">
              Powered by AIESEC <br />© 1948-2021 AIESEC
            </p>
          </div>
        </Col>
        ...
        <Col className="pt-5 align">
         ...
         <button className='btn back-to-top-button'><Link smooth to='#top'><img src={ScrollUp}/></Link></button>
        </Col>
      </Row>
    </Container>
  );
